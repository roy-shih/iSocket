...
secureEsp32FOTA secureEsp32FOTA("iSOC", 0);

void AutoOTA(){
  secureEsp32FOTA._host="raw.githubusercontent.com"; //e.g. example.com
  secureEsp32FOTA._descriptionOfFirmwareURL="/roy-shih/esp32-ota/master/fota/firmware.json"; //e.g. /my-fw-versions/firmware.json
